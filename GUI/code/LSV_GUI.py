...
"")
    ...
    def retranslateUi(self, LSV):
        ...
        self.voltage_ref.setCurrentText(_translate("LSV", "Ag/AgCl"))
        self.voltage_ref.setItemText(0, _translate("LSV", "Ag/AgCl"))
        self.voltage_ref.setItemText(1, _translate("LSV", "SCE"))
        self.voltage_ref_2.setCurrentText(_translate("LSV", "Ag/AgCl"))
        self.voltage_ref_2.setItemText(0, _translate("LSV", "Ag/AgCl"))
        self.voltage_ref_2.setItemText(1, _translate("LSV", "SCE"))
