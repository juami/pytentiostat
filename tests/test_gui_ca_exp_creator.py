...
# CA_main,; plot,; preview_CA,; write_to_file_CA,
...
# def test_preview_CA():
#     # Create a mock Ui_experiment object
#     exp = MagicMock()
#     exp.experiment_step_number.text.return_value = '10'
#     exp.experiment_voltage.text.return_value = '5.0'
#     exp.experiment_time.text.return_value = '60'
#     exp.experiment_duration.setText = MagicMock()
#
#     # Create a mock QGridLayout object
#     grid = MagicMock()
#
#     # Call the function
#     preview_CA(exp, grid)
#
#     # Check if the plot function was called with the correct parameters
#     expected_times=np.linspace(0, 60, num=11)
#     expected_steps=np.linspace(5.0, 5.0, 11)
#     grid.addWidget.assert_called_once()
#     assert exp.experiment_duration.setText.call_count == 1
