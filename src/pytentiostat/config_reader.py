...
def param_checker(config_data):
    ...
    average_number = {
        "name": "average_number",
        "value": config_data["advanced_parameters"]["average_number"],
    }
    conversion_factor = {
        "name": "conversion_factor",
        "value": config_data["advanced_parameters"]["conversion_factor"],
    }
    cv_start_voltage = {
        "name": "start_voltage",
        "value": config_data["cyclic_voltammetry"]["start_voltage"],
    }
    cv_sweep_rate = {
        "name": "sweep_rate",
        "value": config_data["cyclic_voltammetry"]["sweep_rate"],
    }
    cycle_number = {
        "name": "number_of_cycles",
        "value": config_data["cyclic_voltammetry"]["number_of_cycles"],
    }
    data_out_name = {
        "name": "data_output_filename",
        "value": config_data["general_parameters"]["data_output_filename"],
    }
    data_out_path = {
        "name": "data_output_path",
        "value": config_data["general_parameters"]["data_output_path"],
    }
    end_voltage = {
        "name": "end_voltage",
        "value": config_data["linear_sweep_voltammetry"]["end_voltage"],
    }
    exp_time = {
        "name": "time",
        "value": config_data["chronoamperometry"]["time"],
    }
    exp_type = {
        "name": "experiment_type",
        "value": config_data["general_parameters"]["experiment_type"],
    }
    lsv_start_voltage = {
        "name": "start_voltage",
        "value": config_data["linear_sweep_voltammetry"]["start_voltage"],
    }
    first_turnover = {
        "name": "first_turnover_voltage",
        "value": config_data["cyclic_voltammetry"]["first_turnover_voltage"],
    }
    lsv_sweep_rate = {
        "name": "sweep_rate",
        "value": config_data["linear_sweep_voltammetry"]["sweep_rate"],
    }
    rest_time = {
        "name": "rest_time",
        "value": config_data["general_parameters"]["rest_time"],
    }
    second_turnover = {
        "name": "second_turnover_voltage",
        "value": config_data["cyclic_voltammetry"]["second_turnover_voltage"],
    }
    set_gain = {
        "name": "setpoint_gain",
        "value": config_data["advanced_parameters"]["setpoint_gain"],
    }
    set_offset = {
        "name": "setpoint_offset",
        "value": config_data["advanced_parameters"]["setpoint_offset"],
    }
    shunt_resistor = {
        "name": "shunt_resistor",
        "value": config_data["advanced_parameters"]["shunt_resistor"],
    }
    step_number = {
        "name": "step_number",
        "value": config_data["general_parameters"]["step_number"],
    }
    time_step = {
        "name": "time_step",
        "value": config_data["advanced_parameters"]["time_step"],
    }
    voltage = {
        "name": "voltage",
        "value": config_data["chronoamperometry"]["voltage"],
    }
    ...
    if val not in exp_types:
        message = """Warning!
                 ...
                 """
        sys.exit(message.format(**exp_type))
    ...
    if exp_type["value"] == "LSV":
        ...
        first_voltage_range = abs(
            cv_start_voltage["value"] - first_turnover["value"]
        )
        second_voltage_range = abs(
            first_turnover["value"] - second_turnover["value"]
        )
        third_voltage_range = abs(
            second_turnover["value"] - cv_start_voltage["value"]
        )
        voltage_range = (
    ...
    for i in [
        ...
        if val < voltage_lb or val > voltage_ub:
            message = """Warning!
                ...
                bounds. \nExiting...
                """
            sys.exit(message.format(str(voltage_ub), str(voltage_lb), **i))
    if time_step["value"] < time_step_lb:
        message = """Warning!
                 ...
                 \nExiting...
                 """
        sys.exit(message.format(str(time_step_lb)))
    if step_number["value"] > step_number_ub:
        message = """Warning!
                 ...
                 """
        sys.exit(message.format(str(step_number_ub)))
