...
# -*- coding: utf-8 -*-
#
# pytentiostat documentation build configuration file, created by
...
modindex_common_prefix = ["pytentiostat"]
...
basename = "pytentiostat".replace(" ", "").replace(".", "")
